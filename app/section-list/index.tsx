...
import { ThemedCard, ThemedText, ThemedView } from '@/presentation';
		...
		<ThemedView margin>
			<ThemedCard>
				<SectionList
					...
					ListHeaderComponent={() => (
						<ThemedText type='h1' className='font-bold mb-3 text-center'>Personajes</ThemedText>
					)}
					renderSectionHeader={({ section }) => (
						<ThemedText 
							type='h2' 
							className='font-semibold bg-ligth-background dark:bg-dark-background py-2 pl-2 mb-2 rounded'
						>{section.title}</ThemedText>
					)}
					stickySectionHeadersEnabled
					ListFooterComponent={() => (
						<ThemedText type='h2' className='font-semibold mt-3 mb-10 p-2 bg-ligth-background dark:bg-dark-background'>
