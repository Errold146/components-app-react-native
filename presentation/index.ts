...
export { default as ThemedSwitch } from './shared/ThemedSwitch';
export { default as ThemedView } from './shared/ThemedView';
export { default as ThemedText } from './shared/ThemeText';
